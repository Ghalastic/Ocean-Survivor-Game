...
class Game:
    def __init__(self, parent, initial_ammo, on_game_end):
        ...
        # Load player image
        self.player_image = self.load_image("C:\\insert\\diver\\image\\path\\here.png", (70, 70))
        ...
        self.submarine_image = self.load_image("C:\\insert\\submarine\\image\\path\\here.png", (300, 200))
        ...
        self.obstacle_images = [self.load_image(f"C:\\insert\\fish\\images\\paths\\here{i}.png") for i in range(1, 13)]
